...
type TSearchInputChangeFn = (value: string) => void;
...
const App = observer(() => {
  ...
  const handleSearchChange: TSearchInputChangeFn = (value) => {
    taskStore.setSearchTerm(value);
  };
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <header className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800">Task List MobX</h1>
            <p className="text-gray-600 mt-2">Демонстрация возможностей MobX</p>
          </header>
